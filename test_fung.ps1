...
azcopy sync "https://gpdl01npseadfdl02.blob.core.windows.net/99-config/ADF_DEV/DataFactory/test_fung/?$sastoken_np" "https://gpdl01npseadfstganfield.blob.core.windows.net/99-config/ADF_DEV/DataFactory/test_fung/?$sastoken_stg" --recursive=false --exclude-pattern="*.bak"
